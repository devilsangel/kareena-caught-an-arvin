...
const inviteeList = [
  ...
  { primary: 'Dennis Cherian',           family: ['Dennis Cherian', 'Rachel John Cheriyan'] },
  { primary: 'Priya Cheriyan',           family: ['Priya Cheriyan'] },
  ...
  { primary: 'Mathew Thomas Issac',      family: ['Mathew Thomas Issac'] },
  { primary: 'Maria Antony',             family: ['Maria Antony'] },
  { primary: 'Athul John Mathew',        family: ['Athul John Mathew', 'Merlin Thomas Issac'] },
  { primary: 'M. B. Mathukutty',         family: ['M. B. Mathukutty', 'Binny John'] },
  ...
  { primary: 'Shawn Keecheril',          family: ['Shawn Keecheril' ] },
  {primary: 'Jacob Keecheril',          family: ['Jacob Keecheril', 'Neena Jacob'] },
  { primary: 'Shreya Jacob',             family: ['Shreya Jacob', 'Alvin'] },
  { primary: 'Paul Joseph',              family: ['Paul Joseph', 'Shoba Joseph'] },
  {primary: 'Justin Joseph',             family: ['Justin Joseph'] },
  {primary: 'Jason Joseph',             family: ['Jason Joseph'] },
  ...
  { primary: 'Kevin Joseph',            family: ['Kevin Joseph', 'Neha Mary Thomas'] },
];
